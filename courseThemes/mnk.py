...
class MNK(BaseMNK, BaseWindow):
    def __init__(self, parent, title, x=None, y=None):
        ...
        super().__init__(parent, title, width=1300, height=500, x=x, y=y)
    ...
    def update_functions_fields(self, coef1=None, coef2=None, coef3=None):
        ...
        if coef2 is not None:
            ...
            f22 = [
                coef2[0] * x_val**2 + coef2[1] * x_val + coef2[2]
        ...
        field_arr = [
            self.linear_field,
            self.quadratic_field,
            self.exponential_field,
        ]
    ...
    def create_answers_fields(self):
        ...
        self.quadratic_field = ctk.CTkEntry(
            self,
            width=WIDTH,
            height=HEIGHT,
            corner_radius=15,
        ...
        self.exponential_field = ctk.CTkEntry(
            self,
            width=WIDTH,
            height=HEIGHT,
            corner_radius=15,
    ...
    def create_deviations_fields(self):
        ...
        self.linear_devitation_field = ctk.CTkEntry(
            self,
            width=WIDTH,
            height=HEIGHT,
            corner_radius=15,
        ...
        self.quadratic_devitation_field = ctk.CTkEntry(
            self,
            width=WIDTH,
            height=HEIGHT,
            corner_radius=15,
        ...
        self.exponential_devitation_field = ctk.CTkEntry(
            self,
            width=WIDTH,
            height=HEIGHT,
            corner_radius=15,
