...
class RungeDialog(BaseIntegration):
    ...
    def create_results_fields(self):
        ...
        readonly_fields = [
            self.i_n_simp_field,
            self.i_n_rightrect_field,
            self.i_n_trap_field,
            self.i_n_leftrect_field,
            self.i_2n_simp_field,
            self.i_2n_rightrect_field,
            self.i_2n_trap_field,
            self.i_2n_leftrect_field,
            self.n_simp_field,
            self.n_rightrect_field,
            self.n_trap_field,
            self.n_leftrect_field,
        ]
